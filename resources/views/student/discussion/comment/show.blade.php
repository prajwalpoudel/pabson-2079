            ...
            <div class="kt-widget3__item">
                <div class="kt-widget3__header">
                    <div class="kt-widget3__user-img">
                        <img class="kt-widget3__img" src="{{ getImageUrl($comment->user->profile) }}" alt="">
                    </div>
                    ...
                    <span class="kt-widget3__status kt-font-brand">
                        ...
                        @if($comment->user == frontUser() || $discussion->user == frontUser())
                                    ...
                                    <ul class="kt-nav">
                                        @if( !$discussion->user == frontUser() || $comment->user == frontUser())
                                            <li class="kt-nav__item">
                                                <a href="{{ route('student.discussion.comment.edit', encrypt($comment->id)) }}"
                                                   class="kt-nav__link">
                                        ...
                                        @endif
                                            ...
                                            <a href="javascript:;" class="kt-nav__link"
                                               onclick="confirmation('delete-{{$comment->id}}')">
                                                ...
                                                {!! Form::open(['route' => ['student.discussion.comment.destroy', $comment->id], 'method' => 'post', 'id'=>'delete-'.$comment->id]) !!}
                                                {!! Form::close() !!}
                                            </a>
                                        </li>
