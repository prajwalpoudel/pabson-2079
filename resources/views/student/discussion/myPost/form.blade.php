<div class="kt-portlet__body">
    <div class="form-group row">
        ...
        <div class="col-lg-6">
            ...
            {!!Form::select('subject_id', $subjects, $discussion->subject->subject_id ?? null, ['class' => $errors->first('subject_id') ? 'form-control  is-invalid' : 'form-control'])!!}
            @error('title')
            <div id="subject-id-error" class="error invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
    </div>
    ...
    <div class="kt-form__actions">
        <div class="row">
            <div class="col-lg-6">
                ...
                <a  href="{{ route('student.my-post.index') }}" type="reset" class="btn btn-secondary">Cancel</a>
            </div>
        </div>
    </div>
</div>
