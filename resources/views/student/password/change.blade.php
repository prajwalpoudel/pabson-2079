...
@section('content')
    ...
    <section id="email-template-edit">
        <div class="kt-portlet">
            ...
            {!! Form::model(null, ['route' => ['student.password.update'], 'method' => 'post', 'class' => 'kt-form kt-form--label-right', 'id' => 'change-password-form']) !!}
                ...
                <div class="kt-form__actions">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <a href="{{ route('student.dashboard') }}" type="reset"
