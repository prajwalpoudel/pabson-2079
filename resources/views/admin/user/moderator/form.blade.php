<div class="kt-portlet__body">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-6">
            ...
            {!!Form::select('subject_id[]', $subjects, $moderator->subjects ?? null, ['class' => $errors->first('subject_id') ? 'form-control  is-invalid' : 'form-control', 'multiple' => 'multiple', 'id' => 'subject'])!!}
            @error('subject_id')
            <span style="color: red">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="kt-form__actions">
        <div class="row">
            <div class="col-lg-6">
                ...
                <a href="{{ route('admin.user.moderator.index') }}"
                   type="reset"
