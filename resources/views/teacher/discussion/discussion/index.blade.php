                ...
                <div class="kt-widget3__item">
                    <div class="kt-widget3__header">
                        ...
                        <span class="kt-widget3__status kt-font-brand">
                            @if($discussion->user == frontUser() && request()->route()->getName() ==  'teacher.my-post.index')
                                        ...
                                        <li class="kt-nav__item">
                                            <a href="javascript:;" class="kt-nav__link"
                                               onclick="confirmation('update-comment-{{$discussion->id}}')">
                                                ...
                                                @endif
                                                {!! Form::open(['route' => ['teacher.my-post.update', $discussion->id], 'method' => 'patch', 'id'=>'update-comment-'.$discussion->id]) !!}
                    ...
                    <div class="kt-widget3__body">
                        ...
                        <p class="kt-widget3__text font-weight-bold">
                            <a href="{{ route('teacher.discussion.show', encrypt($discussion->id)) }}">
                    ...
                    <div class="discussion-footer">
                        ...
                        @if($discussion->comment_status)
                            ...
                            @if($discussion->comments_count == 0)
                                    <a href="{{ route('teacher.discussion.show', encrypt($discussion->id)) }}"
                                       class="pl-2"><i class="fa fa-comment"></i> Comment</a>
                                @elseif($discussion->comments_count == 1)
                                    <a href="{{ route('teacher.discussion.show', encrypt($discussion->id)) }}"
                                       class="pl-2"><i class="fa fa-comment"></i> {{ $discussion->comments_count }} Comment</a>
                                @else
                                    <a href="{{ route('teacher.discussion.show', encrypt($discussion->id)) }}"
                                       class="pl-2"><i class="fa fa-comment"></i> {{ $discussion->comments_count }} Comments</a>
                                @endif
                    </span>
                        @endif
                    </div>
